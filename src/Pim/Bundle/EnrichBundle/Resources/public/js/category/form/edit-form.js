...
define(
    [
        ...
        'backbone',
        'pim/form',
        'text!pim/template/category/edit-form',
        'pim/tree/manage',
        'routing',
        'jquery.sidebarize'
    ],
    function (
        ...
        return BaseForm.extend({
            ...
            callbackCurrentCategoryUpdated: function (data) {
                this.setData(data);
                this.extensions['pim-category-edit-form-right-panel'].render();
            },
            ...
            renderCategoriesTree: function (route) {
                ...
                buttons.push($('<a>', {
                    ...
                    'data-original-title': __('pim_enrich.form.category.btn.create.tree')
                }).html(
